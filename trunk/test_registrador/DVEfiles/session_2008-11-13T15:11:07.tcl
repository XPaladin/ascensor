...
# DVE full session
# Saved on Thu Nov 13 15:11:07 2008
# Designs open: 1
#   V1: /home/gjorquer/ascensor/test/vcdplus.vpd
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: REGISTRADOR_test_top.top_io
#   Group count = 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{10 49} {728 757}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 174} {height 373} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 174} {height 373} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 718} {height 179} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group ${top_io} { {REGISTRADOR_test_top.top_io.solicitudes_inicial} {REGISTRADOR_test_top.top_io.clock} {REGISTRADOR_test_top.top_io.botones} {REGISTRADOR_test_top.top_io.solicitudes_final} }
...
gui_open_source -id ${Source.1}  -replace -active REGISTRADOR_test_top.top_io -type {Scope}  /home/gjorquer/ascensor/test/registrador_io.sv
