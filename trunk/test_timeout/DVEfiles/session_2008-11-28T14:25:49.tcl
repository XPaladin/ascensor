...
# DVE full session
# Saved on Fri Nov 28 14:25:49 2008
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{20 97} {725 792}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 255} {height 373} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 153} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 161} {height 373} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 705} {height 166} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
