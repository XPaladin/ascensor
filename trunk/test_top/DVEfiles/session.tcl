...
# DVE full session
# Saved on Tue Dec 2 17:51:04 2008
# Designs open: 1
...
#   Group io_1 signal count = 12
#   Group io_2 signal count = 12
...
#<Session mode="Full" path="/home/gjorquer/ascensor/test_top/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{367 187} {1067 879}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 251} {height 359} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 153} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 158} {height 359} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 178]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 703
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 178
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 700} {height 177} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
set {io} {io}
gui_sg_create ${io}
gui_sg_addsignal -group ${io} { {TOP_test_top.io.clk} {TOP_test_top.io.botones} {TOP_test_top.io.boton_puertas} {TOP_test_top.io.estado_puertas} {TOP_test_top.io.cambio_piso} {TOP_test_top.io.sensor_puertas} {TOP_test_top.io.reset} {TOP_test_top.io.luces} {TOP_test_top.io.display} {TOP_test_top.io.aviso} {TOP_test_top.io.puertas} {TOP_test_top.io.motor} }
set {io_1} {io_1}
gui_sg_create ${io_1}
gui_sg_addsignal -group ${io_1} { {TOP_test_top.io.luces} {TOP_test_top.io.display} {TOP_test_top.io.reset} {TOP_test_top.io.estado_puertas} {TOP_test_top.io.motor} {TOP_test_top.io.sensor_puertas} {TOP_test_top.io.botones} {TOP_test_top.io.boton_puertas} {TOP_test_top.io.cambio_piso} {TOP_test_top.io.puertas} {TOP_test_top.io.clk} {TOP_test_top.io.aviso} }
set {io_2} {io_2}
gui_sg_create ${io_2}
gui_sg_addsignal -group ${io_2} { {TOP_test_top.io.clk} {TOP_test_top.io.botones} {TOP_test_top.io.boton_puertas} {TOP_test_top.io.estado_puertas} {TOP_test_top.io.cambio_piso} {TOP_test_top.io.sensor_puertas} {TOP_test_top.io.reset} {TOP_test_top.io.luces} {TOP_test_top.io.display} {TOP_test_top.io.aviso} {TOP_test_top.io.puertas} {TOP_test_top.io.motor} }
